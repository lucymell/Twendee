      ...
      <div className="home-background">
        <div className="home-body container">
          ...
          <div className="mx-2 resume-container">
            <p className="">
            Twende is an information hub for prospective travelers planning 
            a getaway and it provides information to enable them take the 
            opportunity of lifelong learning, to improve quality of life 
            through the various destinations.
            </p>
            <p>
